    ...
    <div className="pointer ms-auto d-flex align-items-center fw-600 text-grey-900 text-dark lh-26 font-xssss ">
      ...
      <div onClick={handleShow} className="d-flex">
        ...
        <span className="text-success mx-2 align-self-center">
          {parseFloat(gift).toFixed(2)} ONEs
        </span>
      </div>
        ...
        <Modal.Body className="theme-dark-bg" style={{ padding: "0" }}>
          ...
          >
            ...
            <div className="text-success fw-700 p-2">
              <h4>
                <span className="fw-700">Harmony ONE Balance : </span>{" "}
                <img
                  width={20}
                  height={20}
                  src="https://1510220411-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2F-LlEOlYqEG_GKuO5Rehq%2Ficon%2FqcSvKbLO5IrPgebpYMAE%2FHarmony-logo-FC-mark.svg?alt=media&token=6d286aa4-2754-462a-95f3-2aaf15947345"
                />
            ...
            <div className="text-success fw-700 p-2">
              <h4>
                ...
                <img width={20} height={20} src="/assets/images/eth.png" />
                <span className="fw-700 text-primary mx-2 h4">
